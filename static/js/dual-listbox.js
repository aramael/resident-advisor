...
(function($) {
    ...
    $.fn.bootstrapDualListbox = function(options) {
        ...
        return this.each(function() {
            ...
            var container = $('<div class="row-fluid bootstrap-duallistbox-container"><div class="span6 box1"><span class="info-container"><span class="info"></span><button type="button" class="btn btn-mini clear1 pull-right">' + settings.filtertextclear + '</button></span><input placeholder="Filter" class="filter form-control" type="text"><div class="btn-group buttons"><button type="button" class="btn moveall btn-primary" title="Move all">Move All</button><button type="button" class="btn move btn-inverse" title="Move selected">Move selected</button></div><select multiple="multiple" class="form-control" data-duallistbox_generated="true"></select></div><div class="span6 box2"><span class="info-container"><span class="info"></span><button type="button" class="btn btn-mini clear2 pull-right">' + settings.filtertextclear + '</button></span><input placeholder="Filter" class="filter form-control" type="text"><div class="btn-group buttons"><button type="button" class="btn remove btn-inverse" title="Remove selected">Remove selected</button><button type="button" class="btn removeall btn-primary btn-inverse btn-inverse" title="Remove all">Remove All</button></div><select multiple="multiple" class="form-control" data-duallistbox_generated="true"></select></div></div>').insertBefore($this),
                elements = {
                    originalselect: $this,
                    box1: $('.box1', container),
                    box2: $('.box2', container),
